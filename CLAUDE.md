...
### 프리뷰
- 세션 메타데이터 (프로젝트, 경로, 브랜치, 생성일, 메시지 수, 파일 크기)
- 대화 내역 미리보기 (최대 50줄)
- Ctrl+d/u로 스크롤
...
### 디스크 사용량 & 일괄 정리
- 트리 뷰 세션 노드에 파일 크기 표시
- 프리뷰 패널에 Size 행 표시
- Stats 팝업에 총 디스크 사용량 및 도구별 크기 표시
- D 키로 일괄 정리 모드 진입: N일 이전 세션 일괄 삭제
- 삭제 대상 세션 수와 회수 가능한 크기를 실시간 표시
- 최종 확인 팝업으로 안전하게 삭제

### 세션 통계
- i 키로 통계 팝업 표시
- 총 세션 수, 도구별 세션 수, 총 디스크 사용량, 상위 10개 프로젝트
- Esc/i/q로 팝업 닫기
